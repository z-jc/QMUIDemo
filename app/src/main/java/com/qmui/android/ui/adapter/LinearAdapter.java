    ...
    protected void convert(@NonNull BaseViewHolder helper, NativeEntity item) {
        switch (helper.getItemViewType()) {
            ...
            case NativeEntity.TYPE_AD:
                ...
                AdManager.getInstance().showNativeAD((Activity) helper.itemView.getContext(), frameLayout, (int) DisplayUtil.getScreenWidthDp(helper.itemView.getContext()), 0, HXInfoAdStyle.RIGHT_IMAGE);
                break;
        }
    }
}