...
public class FaceBeauty {
     ...
     * 磨皮 and 美白
     *
     * @param softRatio  Math.abs ( seekBar.getProgress () / 10
     * @param whiteRatio GlobalDefinitions.whiteRatio
     * @return mImgView.setImageBitmap(mFaceEditor.BFSoftskin ( Math.abs ( seekBar.getProgress () / 10), GlobalDefinitions.whiteRatio));
     */
